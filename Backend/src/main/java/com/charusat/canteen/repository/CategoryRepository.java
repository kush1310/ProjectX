...
public class CategoryRepository {
    ...
    public Category save(Category c) {
        if (c.getId() == null) {
            ...
            jdbc.update(con -> {
                PreparedStatement ps = con.prepareStatement("INSERT INTO categories (name, canteen_id) VALUES (?,?)",
            ...
            jdbc.update("UPDATE categories SET name=?, canteen_id=? WHERE id=?", c.getName(), c.getCanteenId(),
                    c.getId());
        }
        return c;
    }
