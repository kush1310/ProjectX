...
export const CHARUSAT_LOCATIONS: CampusLocation[] = [
  ...
  { id: 'patel_puff', name: 'Patel Puff Canteen', code: 'PUFF', type: 'canteen', lat: 22.5985, lng: 72.8215, description: 'Go Hunger - Patel Puff Outlet' },
  { id: 'gohunger', name: 'Go Hunger Cafe', code: 'GOHUNGER', type: 'canteen', lat: 22.5998, lng: 72.8212, description: 'Central Plaza Food Court' },
  { id: 'honest', name: 'Honest Restaurant', code: 'HONEST', type: 'canteen', lat: 22.6005, lng: 72.8201, description: 'CSPIT Ground Floor' },
  { id: 'campus_bites', name: 'Campus Bites', code: 'BITES', type: 'canteen', lat: 22.6012, lng: 72.8210, description: 'DEPSTAR First Floor' },
  { id: 'spice_junction', name: 'Spice Junction', code: 'SPICE', type: 'canteen', lat: 22.5990, lng: 72.8198, description: 'PDPIAS Food Court' },
